...
function FilteringTablePagSelecteddoupleclickhidden() {
  ...
  return (
    <div className="table-container">
      ...
      <h5 style={{ color: "pink", marginBottom: "16px" }}>Global Filtering Table with Pagination & Selection & Doubleclick & hidden</h5>

      <GlobalFilter globalFilter={globalFilter} setGlobalFilter={setGlobalFilter} />
      
      <div className="column-visibility-controls" style={{
        margin: "16px 0",
        padding: "12px",
        borderRadius: "4px",
        ...
        <div className="column-checkboxes" style={{
          display: "flex",
          ...
          {allColumns
            ...
            .map((column) => (
              <div key={column.id} className="column-checkbox" style={{
                display: "flex",
                alignItems: "center",
              }}>
                <label style={{
...
export default FilteringTablePagSelecteddoupleclickhidden;